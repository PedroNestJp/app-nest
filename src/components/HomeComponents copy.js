...
<section className="container"> 
        ...
        <div className='imgsTypesPcs'>
            <div className='divTypePc1'>
                ...
                <span className="textTypePc-1 "> <a id='textTypePc' href='./home'> GAMER </a> </span>
            </div>
            <div className='divTypePc2'>
                <img className="img-typepc-2" srcSet={typepc2} alt=""/>
                <span className="textTypePc-2 "> <a id='textTypePc' href='./home'> OFFICE PREMIUM </a> </span>
            </div>
            <div className='divTypePc3'>
                <img className="img-typepc-3" srcSet={typepc3} alt=""/>
                <span className="textTypePc-3 "> <a id='textTypePc' href='./home'> OFFICE </a> </span>
            </div>
        </div>
</section>     
